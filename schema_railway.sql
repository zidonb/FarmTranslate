-- =================================================================
-- BridgeOS Database Schema (Railway Production)
...
CREATE TABLE users (
    ...
    language        TEXT NOT NULL DEFAULT 'English', -- Display language name (e.g. 'English', 'עברית')
...
-- Verify all CASCADE constraints are in place:
-- SELECT 
--     tc.table_name,
--     kcu.column_name,
...
-- Verify subscriptions CHECK constraint includes 'paused':
-- SELECT check_clause 
